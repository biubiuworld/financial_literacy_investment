...
class SecondSkillQuestionPage1(Page):
    form_model = 'player'
    form_fields = ['part2_skill_question1']
...
class SecondSkillQuestionPage2(Page):
    form_model = 'player'
    form_fields = ['part2_skill_question2']
    def before_next_page(self):
...
class SecondSkillQuestionPage3(Page):
    form_model = 'player'
    form_fields = ['part2_skill_question3']
    def before_next_page(self):
...
class SecondSkillQuestionPage4(Page):
    form_model = 'player'
    form_fields = ['part2_skill_question4']
    def before_next_page(self):
...
class SecondSkillQuestionPage5(Page):
    form_model = 'player'
    form_fields = ['part2_skill_question5']
    def before_next_page(self):
